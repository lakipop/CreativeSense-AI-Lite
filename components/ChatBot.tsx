    ...
    <>
      <div className="bg-zinc-50 dark:bg-zinc-950 flex flex-col md:flex-row h-full w-full text-zinc-900 dark:text-zinc-100 font-sans">
        ...
        <div className="h-full w-full flex flex-col bg-white/50 dark:bg-zinc-900/50">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex md:hidden items-center gap-1.5">
                ...
                <label className="flex items-center gap-1 text-xs font-medium cursor-pointer">
                  ...
                  />
                  <span className="hidden xs:inline">SI</span>
                </label>
              </div>
          ...
          {/* Messages Area */}
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4 pb-24 sm:pb-28 md:pb-6 thin-scrollbar">
            <>
              {messages.map((msg, index) => (
                ...
                >
                  <div
                    className={`max-w-[88%] sm:max-w-[85%] md:max-w-md lg:max-w-2xl px-3 sm:px-4 py-2 sm:py-3 rounded-2xl transition-all ${
                      msg.role === "user"
                  ...
                  >
                    <div className="flex items-start gap-2 sm:gap-3">
                      <p className="whitespace-pre-wrap flex-1 leading-relaxed text-sm sm:text-base">
                        {msg.text}
                      </p>
                      {msg.role === "model" && (
                        <div className="flex items-center gap-2 flex-shrink-0 mt-0.5">
                          <button
                            ...
                            className="p-1 sm:p-1.5 rounded-lg bg-zinc-100 dark:bg-zinc-700 text-xs font-medium hover:bg-primary/20 hover:text-primary transition-colors"
                          >
                            🔊
                          </button>
                        </div>
              ...
              {isLoading && (
                <div className="flex justify-start animate-fade-in">
                  <div className="bg-white dark:bg-zinc-800 rounded-2xl rounded-bl-none px-4 sm:px-5 py-3 sm:py-4 border border-zinc-200 dark:border-zinc-700 shadow-sm">
          ...
          {/* Input Area */}
          <div className="md:static fixed bottom-0 left-0 right-0 z-30 p-3 sm:p-4 md:p-5 border-t border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl">
            <form
              onSubmit={handleSend}
            ...
            >
              <input
                ...
                className="flex-1 bg-zinc-50 dark:bg-zinc-800 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl border border-zinc-200 dark:border-zinc-700 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all text-sm"
                disabled={isLoading}
              />
              <button
                type="submit"
                disabled={isLoading || !input.trim()}
                className="p-2.5 sm:p-3 text-zinc-950 bg-mainBtn rounded-xl hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-mainBtn/20 transition-all hover:scale-105 active:scale-95"
